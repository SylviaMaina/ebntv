...
.then((res)=>{
  ...
  return (
    <div className="bg-sky-100 shadow-lg rounded-lg p-8 pb-12 mb-8">
...
<div>
  ...
  <label className='text-gray-500 cursor-pointer ml-2' htmlFor="storeData">Save my email and name for the next time I comment</label>
      ...
      {error && <p className='text-xx text-red-500'>All fields are required</p>}
      <div className='mt-8'>
        <button type="button" onClick={handleCommentSubmission} className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-blue-900 text-lg rounded-full text-white px-8 py-3 cursor-pointer">
Post comment
        </button>
